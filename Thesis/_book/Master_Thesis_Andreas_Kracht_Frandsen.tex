...
\caption{\label{tab:AL-RES-BIG}Komposition af porteføljen for flere horisonter og risikoaversioner, med en kortsalgs restriktion.}
\centering
\resizebox{\linewidth}{!}{
\begin{threeparttable}
\begin{tabular}[t]{llrrrrrrrr}
