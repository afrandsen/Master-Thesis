...
Slutteligt foretages en \emph{Variance Inflation Factor} analyse, som et sidste tjek for multikollinaritet. Analysen foretages i tre skridt. For samtlige foreklarende variable laves følgende regression
...
\hypertarget{kwiatkowski-phillips-schmidt-shin-test-1}{%
\subsection{Kwiatkowski-Phillips-Schmidt-Shin test}\label{kwiatkowski-phillips-schmidt-shin-test-1}}
...
\end{tabular}
\begin{tablenotes}
\item \textit{Denne tabel rapporterer den beskrivende statistik af den multiple regression ift. responsvariablen: merafkastet på aktier, $rx_{t+1}^{\text{a}}$. Hver række repræsenterer et led i den mutiple regression. Dette gøres ud fra $259$ kvartalvise observationer, som spænder over kvartalerne fra 2. kvartal 1954 til 4. kvartal 2018. Koefficienter markeret med \textbf{fed} implicerer signifikans, for et signifikansniveau på $\alpha=0.05$. Standardfejl er justeret for heteroskedasticitet og autokorrelation, \citep{Newey1987}. Konfidensintervallerne for koefficienterne, $t$-værdierne og $p$-værdierne er ligedes dannet på baggrund af de justerede standardfejl. $R^2$ er ligedes rapporteret, bemærk dette er den justerede $R^2$.}
\end{tablenotes}
\end{threeparttable}
\end{table}
...
$x_t^{\sigma_{\text{a}}^2}$ & \textbf{-0.836} & -1.455 & -0.217 & 0.314 & -2.660 & 0.008\\
\rowcolor{gray!6}  $x_t^{\text{smb}}$ & \textbf{-0.004} & -0.006 & -0.001 & 0.001 & -2.827 & 0.005\\
$x_t^{\text{tb}}$ & \textbf{ 2.664} & 0.425 & 4.903 & 1.137 & 2.343 & 0.020\\
...
$x_t^{\sigma_{\text{a}}^2}$ & -1.054 & -2.402 & 0.294 & 0.684 & -1.541 & 0.125\\
\rowcolor{gray!6}  $x_t^{\text{smb}}$ & \textbf{-0.005} & -0.007 & -0.002 & 0.001 & -3.635 & 0.000\\
$x_t^{\text{tb}}$ & 1.967 & -0.324 & 4.258 & 1.163 & 1.691 & 0.092\\
...
Givet den høje korrelation mellem rentespændende samt \emph{Federal Funds Rate}, foretages en suboptimal beslutning ved at fjerne samtlige rentespænd på nær \emph{Yield Spread}. Det korte rentespænd beholdes eftersom denne variabel generelt har udvist størst signifikans på tværs af alle aktivklasser i både den univariate samt multiple regressionsanalyse.
...
\hypertarget{backtest-af-var1-model}{%
\section{Backtest af VAR(1)-model}\label{backtest-af-var1-model}}
...
\hypertarget{portefuxf8ljevalg-med-tidsvarierende-afkast}{%
\section{Porteføljevalg med tidsvarierende afkast}\label{portefuxf8ljevalg-med-tidsvarierende-afkast}}
...
\midrule
\rowcolor{gray!6}  2 & T-Bills & -140.475 & -127.092 & -126.193 & -135.788 & -153.094 & -162.021 & -166.275 & -168.280\\
 & Aktier & 121.967 & 128.205 & 134.044 & 144.344 & 152.061 & 155.704 & 157.448 & 158.277\\
\rowcolor{gray!6}   & Statsobligationer & 79.784 & 68.001 & 57.359 & 53.375 & 62.409 & 67.583 & 70.046 & 71.200\\
 & Virksomhedsobligationer & 38.723 & 30.886 & 34.790 & 38.070 & 38.625 & 38.734 & 38.782 & 38.803\\
\rowcolor{gray!6}  5 & T-Bills & 7.455 & 14.660 & 12.413 & 1.984 & -14.729 & -25.019 & -30.783 & -33.800\\
 & Aktier & 48.917 & 52.559 & 56.888 & 66.100 & 74.768 & 79.727 & 82.359 & 83.636\\
\rowcolor{gray!6}   & Statsobligationer & 32.645 & 27.941 & 22.306 & 21.218 & 29.509 & 35.104 & 38.366 & 40.163\\
 & Virksomhedsobligationer & 10.983 & 4.840 & 8.393 & 10.698 & 10.452 & 10.189 & 10.057 & 10.001\\
\rowcolor{gray!6}  10 & T-Bills & 56.765 & 59.742 & 56.201 & 47.572 & 36.187 & 28.538 & 23.606 & 20.575\\
 & Aktier & 24.567 & 26.136 & 28.604 & 34.590 & 41.112 & 45.416 & 48.086 & 49.647\\
\rowcolor{gray!6}   & Statsobligationer & 16.931 & 15.770 & 13.992 & 14.892 & 20.187 & 23.938 & 26.447 & 28.058\\
 & Virksomhedsobligationer & 1.737 & -1.649 & 1.203 & 2.946 & 2.515 & 2.108 & 1.860 & 1.720\\
\rowcolor{gray!6}  20 & T-Bills & 81.420 & 81.887 & 77.661 & 70.107 & 62.329 & 57.022 & 53.304 & 50.760\\
 & Aktier & 12.392 & 12.681 & 13.905 & 17.588 & 22.209 & 25.542 & 27.831 & 29.350\\
\rowcolor{gray!6}   & Statsobligationer & 9.075 & 9.692 & 10.363 & 12.686 & 16.187 & 18.557 & 20.258 & 21.461\\
 & Virksomhedsobligationer & -2.887 & -4.260 & -1.929 & -0.381 & -0.725 & -1.121 & -1.393 & -1.571\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \textit{Denne tabel rapporterer den beskrivende statistik af den multiple regression ift. responsvariablen: merafkastet på aktier, $rx_{t+1}^{\text{a}}$. Hver række repræsenterer et led i den mutiple regression. Dette gøres ud fra $259$ kvartalvise observationer, som spænder over kvartalerne fra 2. kvartal 1954 til 4. kvartal 2018. Koefficienter markeret med \textbf{fed} implicerer signifikans, for et signifikansniveau på $\alpha=0.05$. Standardfejl er justeret for heteroskedasticitet og autokorrelation, \citep{Newey1987}. Konfidensintervallerne for koefficienterne, $t$-værdierne og $p$-værdierne er ligedes dannet på baggrund af de justerede standardfejl. $R^2$ er ligedes rapporteret, bemærk dette ikke er den justerede $R^2$.}
...
$\gamma$ & Aktiv & 1 & 4 & 8 & 20 & 40 & 60 & 80 & 100\\
\midrule
\rowcolor{gray!6}  2 & T-Bills & 11.689 & 11.904 & 11.829 & 11.406 & 10.747 & 10.439 & 10.294 & 10.225\\
 & Aktier & 19.442 & 20.035 & 20.644 & 21.490 & 21.963 & 22.163 & 22.262 & 22.310\\
\rowcolor{gray!6}   & Statsobligationer & 35.249 & 35.084 & 34.622 & 34.264 & 34.467 & 34.588 & 34.641 & 34.666\\
 & Virksomhedsobligationer & 33.233 & 32.590 & 32.519 & 32.454 & 32.437 & 32.424 & 32.416 & 32.412\\
\rowcolor{gray!6}  5 & T-Bills & 17.362 & 17.665 & 17.108 & 15.729 & 13.904 & 12.814 & 12.237 & 11.957\\
 & Aktier & 18.184 & 18.676 & 19.576 & 21.359 & 22.735 & 23.487 & 23.874 & 24.049\\
\rowcolor{gray!6}   & Statsobligationer & 33.518 & 33.485 & 33.043 & 32.647 & 33.075 & 33.414 & 33.608 & 33.718\\
 & Virksomhedsobligationer & 30.549 & 29.788 & 29.887 & 29.879 & 29.900 & 29.899 & 29.895 & 29.889\\
\rowcolor{gray!6}  10 & T-Bills & 29.228 & 28.916 & 27.570 & 25.060 & 21.879 & 19.849 & 18.596 & 17.855\\
 & Aktier & 15.260 & 15.537 & 16.403 & 18.483 & 20.685 & 22.112 & 22.985 & 23.485\\
\rowcolor{gray!6}   & Statsobligationer & 29.297 & 29.774 & 29.815 & 29.964 & 30.797 & 31.328 & 31.669 & 31.886\\
 & Virksomhedsobligationer & 25.828 & 25.387 & 25.826 & 26.107 & 26.253 & 26.325 & 26.363 & 26.388\\
\rowcolor{gray!6}  20 & T-Bills & 49.307 & 48.165 & 45.794 & 42.009 & 37.999 & 35.259 & 33.350 & 32.039\\
 & Aktier & 10.677 & 10.650 & 11.364 & 13.350 & 15.821 & 17.645 & 18.931 & 19.799\\
\rowcolor{gray!6}   & Statsobligationer & 21.784 & 22.743 & 23.547 & 24.590 & 25.771 & 26.524 & 27.037 & 27.400\\
 & Virksomhedsobligationer & 17.846 & 18.056 & 18.909 & 19.665 & 20.023 & 20.186 & 20.297 & 20.376\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \textit{Denne tabel rapporterer den beskrivende statistik af den multiple regression ift. responsvariablen: merafkastet på aktier, $rx_{t+1}^{\text{a}}$. Hver række repræsenterer et led i den mutiple regression. Dette gøres ud fra $259$ kvartalvise observationer, som spænder over kvartalerne fra 2. kvartal 1954 til 4. kvartal 2018. Koefficienter markeret med \textbf{fed} implicerer signifikans, for et signifikansniveau på $\alpha=0.05$. Standardfejl er justeret for heteroskedasticitet og autokorrelation, \citep{Newey1987}. Konfidensintervallerne for koefficienterne, $t$-værdierne og $p$-værdierne er ligedes dannet på baggrund af de justerede standardfejl. $R^2$ er ligedes rapporteret, bemærk dette ikke er den justerede $R^2$.}
...
Dette appendiks består af udledninger for de anvendte resultater gennem afhandlingen. Notationen som anvendes følger den generelle præsenterede notation fra tidligere kapitler.

\hypertarget{momenter-af-den-lognormale-fordeling}{%
\section{Momenter af den lognormale fordeling}\label{momenter-af-den-lognormale-fordeling}}

Det præsenterede porteføljevalg i den empiriske analyse tog udgangspunkt i en investor med potens nytte. Dette udmyntede sig i antagelsen om lognormale afkast.
