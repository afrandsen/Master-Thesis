...
\caption{\label{tab:STAT}Augmented Dickey-Fuller test resultater for alle variable.}
\centering
\resizebox{\linewidth}{!}{
\begin{threeparttable}
...
\caption{\label{tab:STAT-DIFF}Augmented Dickey-Fuller test resultater. For første-forskels transformerede variable.}
\centering
\resizebox{\linewidth}{!}{
\begin{threeparttable}
\begin{tabular}[t]{lcccccccccccc}
...
\end{tabular}
\begin{tablenotes}
\item \textit{Denne tabel rapporterer værdierne fra \textit{Variance Inflation Factor} analysen for variablene udledt fra \textit{Top-down} analysen.}
\end{tablenotes}
\end{threeparttable}}
\end{table}
...
\caption{\label{tab:AL-BIG}Komposition af porteføljen for flere horisonter og risikoaversioner.}
\centering
\resizebox{\linewidth}{!}{
\begin{threeparttable}
...
\end{tabular}
\begin{tablenotes}
\item \textit{Denne tabel rapporterer kompositionen af portefølje valget for den institutionelle investor over en lang række investeringshorisonter samt risikoaversioner. Allokeringerne er vist i procent.}
\end{tablenotes}
\end{threeparttable}}
\end{table}
...
\caption{\label{tab:AL-RES-BIG}Komposition af porteføljen for flere horisonter og risikoaversioner, med en kortsalgsrestriktion.}
\centering
\resizebox{\linewidth}{!}{
\begin{threeparttable}
\begin{tabular}[t]{llrrrrrrrr}
...
\end{tabular}
\begin{tablenotes}
\item \textit{Denne tabel rapporterer kompositionen af portefølje valget for den institutionelle investor med en kortsalgsrestriktion over en lang række investeringshorisonter samt risikoaversioner. Allokeringerne er vist i procent.}
\end{tablenotes}
\end{threeparttable}}
\end{table}
