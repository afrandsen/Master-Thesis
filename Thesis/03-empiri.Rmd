...
Som pointeret af [@Stambaugh1999] er der flere problemer med estimationen af den univariate regression. For at øge inferensen af estimationsresultaterne følges metoden af [@Goyal2007], som består af en multipel regression. Den medfører en regression af responsvariablen, merafkast, på samtilige laggede forklarende variable. Altså kan den analytisk beskrives som
...
hvor specielt $\nu_t\sim\mathcal{N}(0,\sigma_\nu ^2)$. Nulhypotesen vil på denne form formuleres som $H_0:\sigma_\nu^2=0$, som medfører, at $\mu_t$ er konstant. Teststørrelsen er *Lagrange Multiplier* eller Score teststatistikken for $\sigma_nu ^2=0$ mod alternativet $\sigma_nu ^2>0$. Den er givet ved
...
step_table_rf %>% 
  knitr::kable(caption = 'Top-down modelselektion på det risikofrie aktiv.',
   ...
   kableExtra::kable_styling(bootstrap_options = "striped",
                             latex_options = c("striped", "HOLD_position"),
                             full_width = F) %>% 
   kableExtra::footnote(general = "\\\\textit{Denne tabel rapporterer resultaterne fra \\\\textit{Top-down} modelselektionsanalysen for det risikofrie aktiv.}", threeparttable = T, escape = FALSE, general_title = "")
```
...
step_table_akt %>% 
  knitr::kable(caption = 'Top-down modelselektion på merafkastet af aktier.',
   ...
   kableExtra::kable_styling(bootstrap_options = "striped",
                             latex_options = c("striped", "HOLD_position"),
                             full_width = F) %>% 
   kableExtra::footnote(general = "\\\\textit{Denne tabel rapporterer resultaterne fra \\\\textit{Top-down} modelselektionsanalysen for merafkastet på aktier.}", threeparttable = T, escape = FALSE, general_title = "")
```
...
step_table_s %>% 
  knitr::kable(caption = 'Top-down modelselektion på merafkastet af statsobligationer.',
   ...
   kableExtra::kable_styling(bootstrap_options = "striped",
                             latex_options = c("striped", "HOLD_position"),
                             full_width = F) %>% 
   kableExtra::footnote(general = "\\\\textit{Denne tabel rapporterer resultaterne fra \\\\textit{Top-down} modelselektionsanalysen for merafkastet på statsobligationer.}", threeparttable = T, escape = FALSE, general_title = "")
```
...
step_table_v %>% 
  knitr::kable(caption = 'Top-down modelselektion på merafkastet af virksomhedsobligationer.',
   ...
   kableExtra::kable_styling(bootstrap_options = "striped",
                             latex_options = c("striped", "HOLD_position"),
                             full_width = F) %>% 
   kableExtra::footnote(general = "\\\\textit{Denne tabel rapporterer resultaterne fra \\\\textit{Top-down} modelselektionsanalysen for merafkastet på virksomhedsobligationer.}", threeparttable = T, escape = FALSE, general_title = "")
```
\end{landscape}
...
ggplot(GAM_ANA) +
  geom_line(aes(x=index, y=A, color = 'T-Bills', linetype = "T-Bills")) +
  geom_line(data=GAM_ANA_MYO, aes(x=index, y=A, color = 'T-Bills2', linetype = "T-Bills2")) +
...
ggplot(GAM_ANA) +
  geom_line(aes(x=index, y=B, color = 'Aktier', linetype = "Aktier")) +
  geom_line(data=GAM_ANA_MYO, aes(x=index, y=B, color = 'Aktier', linetype = "Aktier2")) +
  coord_cartesian(xlim = c(1, 0),
...
ggplot(GAM_ANA) +
  geom_line(aes(x=index, y=C, color = 'Statsobligationer', linetype = "Statsobligationer")) +
  geom_line(data=GAM_ANA_MYO, aes(x=index, y=C, color = 'Statsobligationer2', linetype = "Statsobligationer2")) +
  coord_cartesian(xlim = c(1, 0),
...
ggplot(GAM_ANA) +
  geom_line(aes(x=index, y=D, color = 'Virksomhedsobligationer', linetype = "Virksomhedsobligationer")) +
  geom_line(data=GAM_ANA_MYO, aes(x=index, y=D, color = 'Virksomhedsobligationer2', linetype = "Virksomhedsobligationer2")) +
  coord_cartesian(xlim = c(1, 0),
