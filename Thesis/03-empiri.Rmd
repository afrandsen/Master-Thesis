...
```{r NET-TB-tids, echo=FALSE, fig.align='center', fig.cap="Tidsserie af log netto renten \\\\\\raggedright Tidsserien spænder fra 2. kvartal 1954 til 4. kvartal 2018.", fig.scap="short", fig.width=18, fig.height=5, fig.pos='htbp!'}
ggplot(data) +
...
```{r AKT-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af log merafkastet af aktier.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r S-OBL-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af log merafkastet på statsobligationer.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r V-OBL-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af log merafkastet på virksomhedsobligationer.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r DP-AK, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af log Dividend Price Ratio.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r DP-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af log Dividend Price Ratio.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r PE-AK, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af log Price Earnings Ratio.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r PE-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af log Price Earnings Ratio.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r BM-AK, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Book-to-market Ratio.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r BM-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Book-to-market Ratio.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r AV-AK, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af aktievariansen.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r AV-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af aktievariansen.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r HML-AK, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af High Minus Low.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r HML-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af High Minus Low.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r SMB-AK, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Small Minus Big.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r SMB-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Small Minus Big.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r B-AK, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af log brutto afkastet på det risikofrie aktiv.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r B-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af log brutto afkastet på det risikofrie aktiv.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r TS-AK, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Term Spread.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r TS-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Term Spread.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r YS-AK, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Yield Spread.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r YS-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Yield Spread.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r CS-AK, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Credit Spread.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r CS-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Credit Spread.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r DS-AK, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Default Spread.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r DS-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Default Spread.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r FR-AK, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Federal Funds Rate.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
```{r FR-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Federal Funds Rate.', fig.width=18, fig.height=5, fig.pos='htbp!'}
...
rownames(FIT_TABLE) <- c('$x_t^{\\text{dp}_{\\text{d}}}$', '$x_t^{\\text{pe}_{\\text{d}}}$', '$x_t^{\\text{bm}_{\\text{d}}}$', '$x_t^{\\sigma_{\\text{a}}^2}$', '$x_t^{\\text{hml}}$', '$x_t^{\\text{smb}}$', '$x_t^{\\text{b}_{\\text{d}}}$', '$x_t^{\\text{ts}}$', '$x_t^{\\text{ys}}$', '$x_t^{\\text{cs}}$', '$x_t^{\\text{ds}}$', '$x_t^{\\text{fr}_{\\text{d}}}$')
...
Ligedes rapporterer Tabel \@ref(tab:UNI-s) de univariate regressions resultater af log merafkastet på statsobligationer, $rx_{t+1}^s$, overfor den introducerede delmængde af mulige prædiktionsvariable. Mest overraskende er, at *Yield Spread* ikke er signifikant, som den eneste af de fire rentespænds variablene. Til gengæld prædikterer *Yield Spread* merafkastet på statsobligationer positivt, hvilket også følger tidligere litteratur, [@Fama1987]. Dette er også tilfældet for de resterende rentespænd. Af alle rentestruktursvariablene er det kun *Term Spread*, *Credit Spread* og *Default Spread* som er signifikante for denne stikprøve, med $t$-størrelser på hhv. `r  round(FIT_S_TABLE$t[8], 3)`, `r  round(FIT_S_TABLE$t[10], 3)` og `r  round(FIT_S_TABLE$t[11], 3)`. En stigning i den nuværende *Term Spread* kommer eksempelvis enten fra en forøgelse af den lange effektive rente, $Y_t^10$, eller et fald i den korte effektive rente, $Y_t^90$, eller en kombination af begge vil lede til en stigning i det fremtidige log merafkast på statsobligationer. Ift. de finansielle variable er det kun *Small Minus Big*, som har statistisk styrke i den univariate opsætning, med en $t$-størrelse på `r  round(FIT_S_TABLE$t[6], 3)`. *Small Minus Big* prædikterer merafkastet negativt, hvilket *Dividend-Price Ratio*, *Book-to-Market Ratio* ligeledes gør. Den makroøkonomiske variabel *Federal Funds Rate* er signifikant på et $10\%$ signifikansniveau, og prædikterer merafkastet negativt.
...
rownames(FIT_S_TABLE) <- c('$x_t^{\\text{dp}_{\\text{d}}}$', '$x_t^{\\text{pe}_{\\text{d}}}$', '$x_t^{\\text{bm}_{\\text{d}}}$', '$x_t^{\\sigma_{\\text{a}}^2}$', '$x_t^{\\text{hml}}$', '$x_t^{\\text{smb}}$', '$x_t^{\\text{b}_{\\text{d}}}$', '$x_t^{\\text{ts}}$', '$x_t^{\\text{ys}}$', '$x_t^{\\text{cs}}$', '$x_t^{\\text{ds}}$', '$x_t^{\\text{fr}_{\\text{d}}}$')
...
rownames(FIT_V_TABLE) <- c('$x_t^{\\text{dp}_{\\text{d}}}$', '$x_t^{\\text{pe}_{\\text{d}}}$', '$x_t^{\\text{bm}_{\\text{d}}}$', '$x_t^{\\sigma_{\\text{a}}^2}$', '$x_t^{\\text{hml}}$', '$x_t^{\\text{smb}}$', '$x_t^{\\text{b}_{\\text{d}}}$', '$x_t^{\\text{ts}}$', '$x_t^{\\text{ys}}$', '$x_t^{\\text{cs}}$', '$x_t^{\\text{ds}}$', '$x_t^{\\text{fr}_{\\text{d}}}$')
...
rownames(FIT_M_TABLE) <- c('Afskæring', '$x_t^{\\text{dp}_{\\text{d}}}$', '$x_t^{\\text{pe}_{\\text{d}}}$', '$x_t^{\\text{bm}_{\\text{d}}}$', '$x_t^{\\sigma_{\\text{a}}^2}$', '$x_t^{\\text{hml}}$', '$x_t^{\\text{smb}}$', '$x_t^{\\text{b}_{\\text{d}}}$', '$x_t^{\\text{ts}}$', '$x_t^{\\text{ys}}$', '$x_t^{\\text{cs}}$', '$x_t^{\\text{ds}}$', '$x_t^{\\text{fr}_{\\text{d}}}$')
...
```{r MULT-ak-auto, echo=FALSE, fig.align='center', fig.cap='Simulerede afkast fra første simulering.', fig.width=18, fig.asp=0.9, fig.pos='htbp!'}
...
```{r MULT-ak-step-auto, echo=FALSE, fig.align='center', fig.cap='Simulerede afkast fra første simulering.', fig.width=18, fig.asp=0.9, fig.pos='htbp!'}
...
rownames(FIT_M_S_TABLE) <- c('Afskæring', '$x_t^{\\text{dp}_{\\text{d}}}$', '$x_t^{\\text{pe}_{\\text{d}}}$', '$x_t^{\\text{bm}_{\\text{d}}}$', '$x_t^{\\sigma_{\\text{a}}^2}$', '$x_t^{\\text{hml}}$', '$x_t^{\\text{smb}}$', '$x_t^{\\text{b}_{\\text{d}}}$', '$x_t^{\\text{ts}}$', '$x_t^{\\text{ys}}$', '$x_t^{\\text{cs}}$', '$x_t^{\\text{ds}}$', '$x_t^{\\text{fr}_{\\text{d}}}$')
...
rownames(FIT_M_V_TABLE) <- c('Afskæring', '$x_t^{\\text{dp}_{\\text{d}}}$', '$x_t^{\\text{pe}_{\\text{d}}}$', '$x_t^{\\text{bm}_{\\text{d}}}$', '$x_t^{\\sigma_{\\text{a}}^2}$', '$x_t^{\\text{hml}}$', '$x_t^{\\text{smb}}$', '$x_t^{\\text{b}_{\\text{d}}}$', '$x_t^{\\text{ts}}$', '$x_t^{\\text{ys}}$', '$x_t^{\\text{cs}}$', '$x_t^{\\text{ds}}$', '$x_t^{\\text{fr}_{\\text{d}}}$')
...
data %>% 
  ...
  kableExtra::add_header_above(c(" ", "Forventet afkast" = 1, "Volatilitet" = 1, "Korrelationer" = 3)) %>% 
   kableExtra::footnote(general = "\\\\textit{Denne tabel rapporterer det sande: forventede afkast og volatilitet for de tre fiktive aktiver samt de sande korrelationer mellem aktiverne. Momenterne er opgjort kvartalsvist.}", threeparttable = T, escape = FALSE)
```
