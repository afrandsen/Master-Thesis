...
Også for responsvariablen: merafkastet på statsobligationer er de forklarende variable iterativt blevet fjernet fra *Kitchen-Sink* regressionen, gennem *Step-AIC*-proceduren. Tabel \@ref(tab:MULT-step-s) viser den resulterende multiple regression.
