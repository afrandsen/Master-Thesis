...
step_table_rf %>% 
  knitr::kable(caption = 'Top-down modelselektion på det risikofrie aktiv.',
   ...
   kableExtra::kable_styling(bootstrap_options = "striped",
                             latex_options = c("striped", "HOLD_position"),
                             full_width = F) %>% 
   kableExtra::footnote(general = "\\\\textit{Denne tabel rapporterer resultaterne fra \\\\texti{Top-down} modelselektionsanalysen for det risikofrie aktiv.}", threeparttable = T, escape = FALSE, general_title = "")
```
...
step_table_akt %>% 
  knitr::kable(caption = 'Top-down modelselektion på merafkastet af aktier.',
   ...
   kableExtra::kable_styling(bootstrap_options = "striped",
                             latex_options = c("striped", "HOLD_position"),
                             full_width = F) %>% 
   kableExtra::footnote(general = "\\\\textit{Denne tabel rapporterer resultaterne fra \\\\texti{Top-down} modelselektionsanalysen for merafkastet på aktier.}", threeparttable = T, escape = FALSE, general_title = "")
```
...
step_table_s %>% 
  knitr::kable(caption = 'Top-down modelselektion på merafkastet af statsobligationer.',
   ...
   kableExtra::kable_styling(bootstrap_options = "striped",
                             latex_options = c("striped", "HOLD_position"),
                             full_width = F) %>% 
   kableExtra::footnote(general = "\\\\textit{Denne tabel rapporterer resultaterne fra \\\\texti{Top-down} modelselektionsanalysen for merafkastet på statsobligationer.}", threeparttable = T, escape = FALSE, general_title = "")
```
...
step_table_v %>% 
  knitr::kable(caption = 'Top-down modelselektion på merafkastet af virksomhedsobligationer.',
   ...
   kableExtra::kable_styling(bootstrap_options = "striped",
                             latex_options = c("striped", "HOLD_position"),
                             full_width = F) %>% 
   kableExtra::footnote(general = "\\\\textit{Denne tabel rapporterer resultaterne fra \\\\texti{Top-down} modelselektionsanalysen for merafkastet på virksomhedsobligationer.}", threeparttable = T, escape = FALSE, general_title = "")
```
\end{landscape}
...
Som et stationaritetstjek af den færdige VAR-model, undersøges stabiliteten af modellen. Eftersom en stabil VAR-model vil medføre en stationær VAR-model, [@Lutkepohl2006]. En VAR(1)-model er stabil, hvis det omvendte karateristiske polynomie
