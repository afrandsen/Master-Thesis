...
ggplot(GAM_ANA) +
  geom_line(aes(x=index, y=A, color = 'T-Bills', linetype = "T-Bills")) +
  geom_line(data=GAM_ANA_MYO, aes(x=index, y=A, color = 'T-Bills', linetype = "T-Bills")) +
...
ggplot(GAM_ANA) +
  geom_line(aes(x=index, y=B, color = 'Aktier', linetype = "Aktier")) +
  geom_line(data=GAM_ANA_MYO, aes(x=index, y=B, color = 'Aktier', linetype = "Aktier")) +
  coord_cartesian(xlim = c(1, 0),
...
ggplot(GAM_ANA) +
  geom_line(aes(x=index, y=C, color = 'Statsobligationer', linetype = "Statsobligationer")) +
  geom_line(data=GAM_ANA_MYO, aes(x=index, y=C, color = 'Statsobligationer', linetype = "Statsobligationer")) +
  coord_cartesian(xlim = c(1, 0),
...
ggplot(GAM_ANA) +
  geom_line(aes(x=index, y=D, color = 'Virksomhedsobligationer', linetype = "Virksomhedsobligationer")) +
  geom_line(data=GAM_ANA_MYO, aes(x=index, y=D, color = 'Virksomhedsobligationer', linetype = "Virksomhedsobligationer")) +
  coord_cartesian(xlim = c(1, 0),
