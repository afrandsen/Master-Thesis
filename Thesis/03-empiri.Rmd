...
```{r NET-TB-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af log netto renten.', fig.width=18, fig.height=5, fig.pos='H'}
...
```{r AKT-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af log merafkastet af aktier.', fig.width=18, fig.height=5, fig.pos='H'}
...
```{r S-OBL-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af log merafkastet på statsobligationer.', fig.width=18, fig.height=5, fig.pos='H'}
...
```{r V-OBL-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af log merafkastet på virksomhedsobligationer.', fig.width=18, fig.height=5, fig.pos='H'}
...
```{r DP-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af log Dividend Price Ratio.', fig.width=18, fig.height=5, fig.pos='H'}
...
```{r PE-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af log Price Earnings Ratio.', fig.width=18, fig.height=5, fig.pos='H'}
...
```{r BM-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Book-to-market Ratio.', fig.width=18, fig.height=5, fig.pos='H'}
...
```{r AV-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af aktievariansen.', fig.width=18, fig.height=5, fig.pos='H'}
...
```{r HML-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af High Minus Low.', fig.width=18, fig.height=5, fig.pos='H'}
...
```{r SMB-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Small Minus Big.', fig.width=18, fig.height=5, fig.pos='H'}
...
```{r B-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af log brutto afkastet på det risikofrie aktiv.', fig.width=18, fig.height=5, fig.pos='H'}
...
```{r TS-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Term Spread.', fig.width=18, fig.height=5, fig.pos='H'}
...
```{r YS-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Yield Spread.', fig.width=18, fig.height=5, fig.pos='H'}
...
```{r CS-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Credit Spread.', fig.width=18, fig.height=5, fig.pos='H'}
...
```{r DS-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Default Spread.', fig.width=18, fig.height=5, fig.pos='H'}
...
```{r FR-HIST, echo=FALSE, fig.align='center', fig.cap='Autokorrelation af Federal Funds Rate.', fig.width=18, fig.height=5, fig.pos='H'}
...
Sidst ses i Tabel \@ref(tab:MULT-v) at log merafkastet på virksomhedsobligationer er svært prædiktabelt i det multiple setup. Kun *Small Minus Big* samt *Federal Funds Rate* er signifikante med $t$-størrelser på hhv. `r round(FIT_M_V_TABLE$t[7], 3)` og `r round(FIT_M_V_TABLE$t[13], 3)`.
...
ggplot(HOR_ANA) +
  ...
  coord_cartesian(ylim = c(min(HOR_ANA[,1:3])-0.1, max(HOR_ANA[,1:3]))+0.05) +
  scale_linetype_manual(values=c("solid", "dashed", "dotted", "dotdash"))+
  scale_y_continuous(expand=c(0,0))+
  scale_colour_brewer(palette = "Dark2") +
  theme_bw()+
...
ggplot(HOR_ANA_R) +
  ...
  geom_line(aes(x=index, y=C, color = 'Statsobligationer', linetype = "Statsobligationer")) +
  geom_line(aes(x=index, y=D, color = 'Virksomhedsobligationer', linetype = "Virksomhedsobligationer")) +
  coord_cartesian(ylim = c(min(HOR_ANA_R[,1:3])-0.1, max(HOR_ANA_R[,1:3]))+0.05) +
  scale_linetype_manual(values=c("solid", "dashed", "dotted", "dotdash"))+
  scale_y_continuous(expand=c(0,0))+
  scale_colour_brewer(palette = "Dark2") +
  theme_bw()+
