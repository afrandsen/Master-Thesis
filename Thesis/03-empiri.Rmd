...
DESCRIPTIVE %>% 
  knitr::kable(caption = 'Beskrivende statistik for de fire aktivklasser.',
   ...
   kableExtra::kable_styling(bootstrap_options = "striped",
                             ...
                             full_width = F) %>% 
   kableExtra::footnote(general = "\\\\textit{Denne tabel rapporterer kvartalsvis beskrivende statistik for aktivklasserne: det risikofrie aktiv, merafkastet på aktier, merfafkastet på statsobligationer og merafkastet på virksomhedsobligationer. Dette gøres ud fra $259$ kvartalvise observationer, som spænder over kvartalerne fra 2. kvartal 1954 til 4. kvartal 2018. Middelværdien er justeret for alle aktivklasser.}", threeparttable = T, escape = FALSE)
```
\end{landscape}
