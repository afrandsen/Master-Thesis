...
colnames(FIT_M_S_STEP_TABLE) <- c('Koefficient', 'Nedre', 'Øvre', 'Standardfejl', '$t$-værdi', '$p$')
...
colnames(FIT_M_V_STEP_TABLE) <- c('Koefficient', 'Nedre', 'Øvre', 'Standardfejl', '$t$-værdi', '$p$')
...
For at formindske modelkompleksiteten i VAR-modellen udføres den beskrevne *Top-down*/*backward-elimination* analyse, fra Sektion \@ref(sekmodelselek). Eftersom afkastprædiktabilitetsanalysen var kendetegnet ved lave signifikans niveauer, forventes det, at *AKFIC* analysen vil reducere antallet af relevante tilstandsvariable kraftigt. På denne måde vil en fuldt defineret VAR-process forhåbentligt stemme overens med de a priori teoretiske forventninger, og samtidig have et konservativt antal parametre, der givetvis vil følge det abduktive heuristiske parsimoni-princip kendt som *Occam's Razor*^[Den fordanskede udgave er næsten at foretrække: Ockhams ragekniv.] Derudover vil et reduceret system sandsynligvis signifikant formindske støjen af de estimerede koefficienter, som dermed vil lede til bedre eksterne stikprøve resultater^[Givet at denne stikprøve er repræsentativ for modelleringsstikprøven.]
...
Som forventet på baggrund af den høje korrelation mellem rentespændende samt *Federal Funds Rate*, ses en høj *VIF* værdi for disse variable. Derfor foretages en suboptimal beslutning ved at fjerne samtlige rentespænd på nær *Yield Spread*. Det korte rentespænd beholdes eftersom denne variabel generelt har udvist størst signifikans på tværs af alle aktivklasser i både den univariate samt multiple regressionsanalyse. På baggrund af den forholdsvis begrænsede stikprøvestørrelse vælges ligeledes at udeholde aktievariansen fra modellen. Dette gøres for at opretholde en lige fordeling af finansielle variable ift. rentestruktursvariable.
...
ggplot(data) +
  expand_limits(x = min(index(data)), y = min(data$NET_TB))+
  geom_line(aes(x=index(data), y=NET_TB, color = "Sand", linetype = "Sand"), linetype="solid", color ="black") +
  geom_line(aes(x=index(data), y=FITTED, color = "Estimeret", linetype = "Estimeret"), linetype="dashed", color ="red") +
  geom_rect(data=recessions.trim, aes(xmin=Peak, xmax=Trough, ymin=-Inf, ymax=+Inf), fill='pink', alpha=0.2)+
  coord_cartesian(ylim = c(min(data$NET_TB), max(data$NET_TB))) +
  scale_x_date(expand = c(0, 0), date_labels = "%Y", date_breaks = "2 year", limits = c(min(index(data)), max(index(data))))+
  scale_y_continuous(expand=c(0,0))+
...
ggplot(data) +
  expand_limits(x = min(index(data)), y = min(data$AKT))+
  geom_line(aes(x=index(data), y=AKT, color = "Sand", linetype = "Sand"), linetype="solid", color ="black") +
  geom_line(aes(x=index(data), y=FITTED, color = "Estimeret", linetype = "Estimeret"), linetype="dashed", color ="red") +
  geom_rect(data=recessions.trim, aes(xmin=Peak, xmax=Trough, ymin=-Inf, ymax=+Inf), fill='pink', alpha=0.2)+
  coord_cartesian(ylim = c(min(data$AKT), max(data$AKT))) +
  scale_x_date(expand = c(0, 0), date_labels = "%Y", date_breaks = "2 year", limits = c(min(index(data)), max(index(data))))+
...
ggplot(data) +
  expand_limits(x = min(index(data)), y = min(data$S_OBL))+
  geom_line(aes(x=index(data), y=S_OBL, color = "Sand", linetype = "Sand"), linetype="solid", color ="black") +
  geom_line(aes(x=index(data), y=FITTED, color = "Estimeret", linetype = "Estimeret"), linetype="dashed", color ="red") +
  geom_rect(data=recessions.trim, aes(xmin=Peak, xmax=Trough, ymin=-Inf, ymax=+Inf), fill='pink', alpha=0.2)+
  coord_cartesian(ylim = c(min(data$S_OBL), max(data$S_OBL))) +
  scale_x_date(expand = c(0, 0), date_labels = "%Y", date_breaks = "2 year", limits = c(min(index(data)), max(index(data))))+
...
ggplot(data) +
  expand_limits(x = min(index(data)), y = min(data$V_OBL))+
  geom_line(aes(x=index(data), y=V_OBL, color = "Sand", linetype = "Sand"), linetype="solid", color ="black") +
  geom_line(aes(x=index(data), y=FITTED, color = "Estimeret", linetype = "Estimeret"), linetype="dashed", color ="red") +
  geom_rect(data=recessions.trim, aes(xmin=Peak, xmax=Trough, ymin=-Inf, ymax=+Inf), fill='pink', alpha=0.2)+
  coord_cartesian(ylim = c(min(data$V_OBL), max(data$V_OBL))) +
  scale_x_date(expand = c(0, 0), date_labels = "%Y", date_breaks = "2 year", limits = c(min(index(data)), max(index(data))))+
...
ggplot(data) +
  expand_limits(x = min(index(data)), y = min(data$BM))+
  geom_line(aes(x=index(data), y=BM, color = "Sand", linetype = "Sand"), linetype="solid", color ="black") +
  geom_line(aes(x=index(data), y=FITTED, color = "Estimeret", linetype = "Estimeret"), linetype="dashed", color ="red") +
  geom_rect(data=recessions.trim, aes(xmin=Peak, xmax=Trough, ymin=-Inf, ymax=+Inf), fill='pink', alpha=0.2)+
  coord_cartesian(ylim = c(min(data$BM), max(data$BM))) +
  scale_x_date(expand = c(0, 0), date_labels = "%Y", date_breaks = "2 year", limits = c(min(index(data)), max(index(data))))+
...
ggplot(data) +
  expand_limits(x = min(index(data)), y = min(data$SMB))+
  geom_line(aes(x=index(data), y=SMB, color = "Sand", linetype = "Sand"), linetype="solid", color ="black") +
  geom_line(aes(x=index(data), y=FITTED, color = "Estimeret", linetype = "Estimeret"), linetype="dashed", color ="red") +
  geom_rect(data=recessions.trim, aes(xmin=Peak, xmax=Trough, ymin=-Inf, ymax=+Inf), fill='pink', alpha=0.2)+
  coord_cartesian(ylim = c(min(data$SMB), max(data$SMB))) +
  scale_x_date(expand = c(0, 0), date_labels = "%Y", date_breaks = "2 year", limits = c(min(index(data)), max(index(data))))+
...
ggplot(data) +
  expand_limits(x = min(index(data)), y = min(data$TB))+
  geom_line(aes(x=index(data), y=TB, color = "Sand", linetype = "Sand"), linetype="solid", color ="black") +
  geom_line(aes(x=index(data), y=FITTED, color = "Estimeret", linetype = "Estimeret"), linetype="dashed", color ="red") +
  geom_rect(data=recessions.trim, aes(xmin=Peak, xmax=Trough, ymin=-Inf, ymax=+Inf), fill='pink', alpha=0.2)+
  coord_cartesian(ylim = c(min(data$TB), max(data$TB))) +
  scale_x_date(expand = c(0, 0), date_labels = "%Y", date_breaks = "2 year", limits = c(min(index(data)), max(index(data))))+
...
ggplot(data) +
  expand_limits(x = min(index(data)), y = min(data$Y_SPREAD))+
  geom_line(aes(x=index(data), y=Y_SPREAD, color = "Sand", linetype = "Sand"), linetype="solid", color ="black") +
  geom_line(aes(x=index(data), y=FITTED, color = "Estimeret", linetype = "Estimeret"), linetype="dashed", color ="red") +
  geom_rect(data=recessions.trim, aes(xmin=Peak, xmax=Trough, ymin=-Inf, ymax=+Inf), fill='pink', alpha=0.2)+
  coord_cartesian(ylim = c(min(data$Y_SPREAD), max(data$Y_SPREAD))) +
  scale_x_date(expand = c(0, 0), date_labels = "%Y", date_breaks = "2 year", limits = c(min(index(data)), max(index(data))))+
