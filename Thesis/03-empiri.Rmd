...
```{r NET-TB-tids, echo=FALSE, fig.align='center', fig.cap="Tidsserie af log netto renten.", fig.scap="Tidsserie af log netto renten.", fig.width=18, fig.height=5, fig.pos='H'}
ggplot(data) +
...
```{r MULT-s-auto, echo=FALSE, fig.align='center', fig.cap='Visuel inspektion af Kitchen-Sink regressionen for merafkastet på statsobligationer.', fig.width=18, fig.asp=0.9, fig.pos='H'}
...
```{r MULT-s-step-auto, echo=FALSE, fig.align='center', fig.cap='Visuel inspektion af den step optimerede regression for merafkastet på statsobligationer.', fig.width=18, fig.asp=0.9, fig.pos='H'}
...
```{r MULT-v-auto, echo=FALSE, fig.align='center', fig.cap='Visuel inspektion af Kitchen-Sink regressionen for merafkastet på virksomhedsobligationer.', fig.width=18, fig.asp=0.9, fig.pos='H'}
...
rownames(FIT_M_V_STEP_TABLE) <- c('Afskæring', '$x_t^{\\text{a}}$', '$x_t^{\\text{smb}}$', '$x_t^{\\text{b}}$', '$x_t^{\\text{ds}}$', '$x_t^{\\text{fr}}$')
...
FIT_M_V_STEP_TABLE %>% 
  knitr::kable(caption = 'Step optimeret multipel prædiktabilitet af merafkastet på virksomhedsobligationer',
   ...
   kableExtra::kable_styling(bootstrap_options = "striped",
                             ...
                             full_width = F)  %>% 
   kableExtra::add_header_above(c("$rx_{t+1}^{\\\\text{a}}$", " " = 1, "Konfidensinterval" = 2, " " = 3), escape = FALSE) %>% 
   kableExtra::footnote(general = "\\\\textit{Denne tabel rapporterer den beskrivende statistik af en AIC step optimeret multipel regression ift. responsvariablen: merafkastet på virksomhedsobligationer, $rx_{t+1}^{\\\\text{a}}$. Hver række repræsenterer et led i den mutiple regression. Dette gøres ud fra $259$ kvartalvise observationer, som spænder over kvartalerne fra 2. kvartal 1954 til 4. kvartal 2018. Koefficienter markeret med \\\\textbf{fed} implicerer signifikans, for et signifikansniveau på $\\\\alpha=0.05$. Standardfejl er justeret for heteroskedasticitet og autokorrelation, (ref:nw1987). Konfidensintervallerne for koefficienterne, $t$-værdierne og $p$-værdierne er ligedes dannet på baggrund af de justerede standardfejl. $R^2$ er på ??, bemærk dette ikke er den justerede $R^2$.}", threeparttable = T, escape = FALSE, general_title = "")
```

Sidst viser Figur \@ref(fig:MULT-v-step-auto) modelsinpektionsplottene fra den step optimerede multiple regression.

```{r MULT-v-step-auto, echo=FALSE, fig.align='center', fig.cap='Visuel inspektion af den step optimerede regression for merafkastet på virksomhedsobligationer.', fig.width=18, fig.asp=0.9, fig.pos='H'}
...
a %>% 
  knitr::kable(caption = 'VIF Analyse.',
               booktabs=TRUE,
               align = c(rep('c', 12)),
               row.names = FALSE,
               escape = FALSE,
   ...
   kableExtra::kable_styling(bootstrap_options = "striped",
                             latex_options = c("striped", "HOLD_position", "scale_down"),
                             full_width = F) %>% 
   kableExtra::footnote(general = "\\\\textit{Denne tabel rapporterer \\\\textit{Variance Inflation Factor} analysen for variablene udledt fra \\\\textit{Top-down} analysen.}", threeparttable = T, escape = FALSE, general_title = "")
```
...
a2 %>% 
  knitr::kable(caption = 'VIF Analyse.',
   ...
   kableExtra::kable_styling(bootstrap_options = "striped",
                             latex_options = c("striped", "HOLD_position"),
                             full_width = F) %>% 
   kableExtra::footnote(general = "\\\\textit{Denne tabel rapporterer \\\\textit{Variance Inflation Factor} analysen for de tilbageværende variablene udledt fra \\\\textit{Top-down} analysen og den første \\\\textit{Variance Inflation Factor} analyse.}", threeparttable = T, escape = FALSE, general_title = "")
```
...
COV_RES_TABLE %>% 
  knitr::kable(caption = 'Vector Autoregressive fejlleds korrelationer samt standard afvigelser.',
               booktabs=TRUE,
               align = c(rep('c', 10)),
               row.names = FALSE,
               escape = FALSE,
...
```{r BACKTEST-NET-TB, echo=FALSE, fig.align='center', fig.cap="Backtest af VAR(1)-estimaterne for det risikofrie aktiv.", fig.scap="short", fig.width=18, fig.height=5, fig.pos='H', warning=FALSE}
...
```{r BACKTEST-AKT, echo=FALSE, fig.align='center', fig.cap="Backtest af VAR(1)-estimaterne for merafkastet på aktier.", fig.scap="short", fig.width=18, fig.height=5, fig.pos='H', warning=FALSE}
...
```{r BACKTEST-S, echo=FALSE, fig.align='center', fig.cap="Backtest af VAR(1)-estimaterne for merafkastet på statsobligationer.", fig.scap="short", fig.width=18, fig.height=5, fig.pos='H', warning=FALSE}
...
```{r BACKTEST-V, echo=FALSE, fig.align='center', fig.cap="Backtest af VAR(1)-estimaterne for merafkastet på virksomhedsobligationer.", fig.scap="short", fig.width=18, fig.height=5, fig.pos='H', warning=FALSE}
...
```{r BACKTEST-BM, echo=FALSE, fig.align='center', fig.cap="Backtest af VAR(1)-estimaterne for prædiktionsvariablen Book-to-Market Ratio.", fig.scap="short", fig.width=18, fig.height=5, fig.pos='H', warning=FALSE}
...
```{r BACKTEST-SMB, echo=FALSE, fig.align='center', fig.cap="Backtest af VAR(1)-estimaterne for prædiktionsvariablen Small Minus Big.", fig.scap="short", fig.width=18, fig.height=5, fig.pos='H', warning=FALSE}
...
```{r BACKTEST-B, echo=FALSE, fig.align='center', fig.cap="Backtest af VAR(1)-estimaterne for prædiktionsvariablen den nominelle rente.", fig.scap="short", fig.width=18, fig.height=5, fig.pos='H', warning=FALSE}
...
```{r BACKTEST-Y, echo=FALSE, fig.align='center', fig.cap="Backtest af VAR(1)-estimaterne for prædiktionsvariablen Yield Spread.", fig.scap="short", fig.width=18, fig.height=5, fig.pos='H', warning=FALSE}
