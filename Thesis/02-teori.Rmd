...
Dette kapitel præsenterede det generelle tilfælde af dynamisk portefølje allokering defineret af [@CampVic2003], som undersøger en investor med endelige investeringshorisont og *CRRA*-nytte. Deres analyse er baseret på middelværdi-varians analysen af [@Markowitz1952], denne er til gengæld mangelfuld. Middelværdi-varians analysen modellere kun det statiske valg. For at kunne skabe en portefølje allokering ud fra antagelsen om tidsvarierende afkast, benyttes den teoretiske ramme præsenteret af [@JurVic2011]. Slutteligt præsenteres, hvordan en kortsalgsrestriktion kan medtages i modellen. 