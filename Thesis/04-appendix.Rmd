...
### *Value*-funktionen
Nu udledes de relevante udtryk for koefficienterne, $B_i^2$, i den maksimerede *value*-funktion. Dette gør, at der kan skabes et forhold mellem de foregående værdier af hhv. $A_i^1$ og $B_i^1$ koefficienterne. Ved indsættelse af den optimale porteføljeallokering for tidspunkt $\left(t+k-2\right)$ ind i *value*-funktionen, og ved samtidig udeladelse af konstanter ganget på forventningen, opnås det følgende udtryk
\begin{align*}
